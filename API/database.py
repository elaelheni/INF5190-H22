...
class Database:
  ...
  def set_livre(self, livre):
    ...
    connection.execute('INSERT INTO livre(titre, auteur, annee, nb_pages, nb_chapitres)' 'VALUES(?, ?, ?, ?, ?)', (livre.titre, livre.auteur, livre.annee, livre.nb_pages, livre.nb_chapitres))
    connection.commit()
